...
| ![thumbnail](Apps/ghost/thumbnail.png) | <h2><img src=Apps/ghost/icon.png width=21 height=21> [Ghost](https://ghost.org/)</h2> [![tag](https://img.shields.io/badge/ghcr.io/dgtlmoon/ghost-latest-blue)](https://hub.docker.com/_/ghost/) <br /> Free and open-source blogging platform. |
